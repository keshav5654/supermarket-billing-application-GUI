...
public class bill extends javax.swing.JFrame {
    ...
    jTextArea1.setText("\t"+"welcome to our shop"+"\n"+"Shop Name:family Point"+"\n"+"Contact no:9888000"+"\n"+"Address:abc"+"\n"+"Product/Quentity"+"\t"+"Price"+"\t"+"Total"+"\n");
    }
    /**
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        pr=Integer.parseInt(jTextField2.getText());
        qty=Integer.parseInt(jTextField3.getText());
        tb=pr*qty;
        jTextField4.setText(String.valueOf(tb));
        jTextArea1.setText(jTextArea1.getText()+jTextField1.getText()+"-"+jTextField3.getText()+"\t\t"+jTextField2.getText()+("\t")+jTextField4.getText()+("\t"));
